package com.amtech.shariahEquities.home.activity
...
import com.amtech.shariahEquities.viewPager.ViewPagerAdapter
...
class ExploreFragment : Fragment() {
    ...
    var countCat = 0
    var countS = 0
    private val tabText = arrayOf("Stocks", "Funds", "Baskets")
    ...
    override fun onCreateView(
        ...
        adapter.addFragment(FundsFragment(), "Funds")
        adapter.addFragment(BasketsFragment(), "Baskets")
...
//        binding.viewpager.adapter = ViewPagerAdapter(this as FragmentActivity)
